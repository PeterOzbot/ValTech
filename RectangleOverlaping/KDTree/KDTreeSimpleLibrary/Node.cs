...
namespace KDTreeSimpleLibrary
{
    ...
    public class Node {
        ...
        /// </summary>
        protected internal KDRectangle[] tData;

        // Stem only
        /// <summary>
        /// The left and right children.
        /// </summary>
        protected internal Node pLeft, pRight;
        /// <summary>
        /// The split dimension.
        /// </summary>
        ...
        protected Node() {
            ...
            // Setup leaf elements.
            this.tPoints = new double[24 + 1][];
            this.tData = new KDRectangle[24 + 1];
        }
        #endregion
        ...
        private void ExtendBounds(double[] tPoint) {
            ...
            if (tMinBound == null) {
                tMinBound = new double[4];
                tMaxBound = new double[4];
                Array.Copy(tPoint, tMinBound, 4);
                Array.Copy(tPoint, tMaxBound, 4);
                return;
            }
