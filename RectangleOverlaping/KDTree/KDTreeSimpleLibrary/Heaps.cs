...
namespace KDTreeSimpleLibrary {
    ...
    /// </summary>
    /// <typeparam name="KDRectangle">The type of data this MinHeap stores.</typeparam>
    ...
    public class MinHeap {
        ...
        public MinHeap() {
            this.tData = new Node[64];
            this.tKeys = new double[64];
            this.Capacity = 64;
            this.Size = 0;
        }
    ...
    /// </summary>
    /// <typeparam name="KDRectangle">The data type contained at each key.</typeparam>
    /// <remarks>This is based on this: https://bitbucket.org/rednaxela/knn-benchmark/src/tip/ags/utils/dataStructures/trees/thirdGenKD/ </remarks>
    public class IntervalHeap {
        ...
        public void RemoveMin() {
            ...
            tData[0] = tData[Size];
            tKeys[0] = tKeys[Size];
            tData[Size] = default(KDRectangle);
            SiftDownMin(0);
        }
